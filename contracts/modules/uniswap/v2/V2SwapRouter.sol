...
import {IZebraPair} from '../../../interfaces/IZebraPair.sol';
    ...
    function _v2Swap(address[] calldata path, address recipient, address pair) private {
        unchecked {
            ...
            for (uint256 i; i < finalPairIndex; i++) {
                ...
                (uint256 reserve0, uint256 reserve1,) = IZebraPair(pair).getReserves();
                ...
                (nextPair, token0) = i < penultimatePairIndex
                    ...
                    : (recipient, address(0));
                IZebraPair(pair).swap(amount0Out, amount1Out, nextPair, new bytes(0));
                pair = nextPair;
            }
        }
    }
