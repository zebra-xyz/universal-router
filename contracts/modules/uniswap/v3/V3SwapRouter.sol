...
import {IZebraV3Pool} from '../../../interfaces/IZebraV3Pool.sol';
import {IZebraV3SwapCallback} from '../../../interfaces/IZebraV3SwapCallback.sol';
...
abstract contract V3SwapRouter is UniswapImmutables, Permit2Payments, IZebraV3SwapCallback {
    ...
    /// @notice Performs a Zebra v3 exact output swap
    /// @param recipient The recipient of the output tokens
        ...
        returns (int256 amount0Delta, int256 amount1Delta, bool zeroForOne)
    {
        ...
        (amount0Delta, amount1Delta) = IZebraV3Pool(computePoolAddress(tokenIn, tokenOut, fee)).swap(
            recipient,
            zeroForOne,
            amount,
